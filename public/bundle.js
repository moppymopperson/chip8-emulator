...
require.define("/renderer.js",function(require,module,exports,__dirname,__filename,process,global){class Renderer {
  constructor(canvas) {
    this.canvas = canvas
...
require.define("/index.js",function(require,module,exports,__dirname,__filename,process,global){const Renderer = require('./renderer.js')
